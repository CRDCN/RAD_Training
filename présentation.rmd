...
- Merci au RCCDR et à ses bailleurs de fonds : la FCI, les IRSC, le CRSH, les partenaires provinciaux et les institutions collaboratrices.

Merci d’accéder au dossier du projet pour cet atelier : www.github.com/CRDCN/RAD_training 
...
-   Image of data lifecycle & description (credit: Memorial University OVPR) !["Gestion des données de recherche" Université du Québec](./content/research_data_lifecycle.jpg)
...
![Lunaris webpage screenshot](./content_fr/lunaris.png)
...
![Screenshot of CRDCN dataset database](./content_fr/DB screenshot.jpg)
...
- Dans certains cas, ces champs seront remplis automatiquement et faciles à repérer (ex. "Nom de la base de données").  
- Certains seront dynamiques et moins évidents. 
- Dans certains cas, ils seront statiques et devront être créés manuellement (ex. "Droits"). 
...
## Option 2 – Dépôts de métadonnées uniquement
...
- Votre Dataverse intègre les données, et Borealis les regroupe dans un service national 
- Les informations de Borealis sont collectées par d’autres outils de recherche (y compris Lunaris) 
