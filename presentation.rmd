...
- Any data source can provide a database of information about their datasets to be "harvested"
...
- In some cases these will be dynamic (ex. "Database name")
- In some cases these will be static (ex. "Rights")
